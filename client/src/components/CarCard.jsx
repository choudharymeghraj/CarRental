...
const CarCard = ({ car }) => {
  ...
  const handleClick = () => {
    if (!token) {
      setShowLogin(true)
      return toast.error('Please log in first to see details')
    }
  ...
  return (
    <div onClick={handleClick} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
